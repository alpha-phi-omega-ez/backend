...
If you've noticed a bug or have a feature request, [make one](https://github.com/alpha-phi-omega-ez/backend/issues)! It's generally best if you get confirmation of your bug or approval for your feature request this way before starting to code.
...
For contributing to the code feel free to check out [issues](https://github.com/alpha-phi-omega-ez/backend/issues). When creating a pull request please rebase before merging so that changes are linear in the history.
...
To create a feature or enhancement request please use the feature request [issues](https://github.com/alpha-phi-omega-ez/backend/issues) template.
